/** Marketing copy — editable via lib/cms/content.ts */
export {
  demoPageCopy,
  featureCards,
  footerLinks,
...
export const bodyTypes: {
...
}[] = [
  {
    slug: "walker",
    name: "Walker",
    purpose: "Concept path: movement, gestures, interaction, and personality.",
    bestFor: "Labs exploring biped presence — concept only; Desk One is the reservable EVT product.",
...
export const configurationProducts = [
  {
    name: "Exobod Desk One",
    href: "/desk-one",
    badge: "Available path",
    bestFor: "Early builders who want a real EVT pan/tilt desk dock — the reservable / early-access product.",
    motionType: "Stationary 2-axis pan/tilt. Phone stays the brain. Not a biped.",
    skillExamples: ["Assist", "Present", "Gesture", "Monitor"],
    prototypeTier: "EVT / early-builder access",
  },
  {
    name: "Exobod Walker",
    href: "/customize?type=walker",
    badge: "Concept",
    bestFor: "Labs and demos exploring biped presence — concept path, not a buyable SKU today.",
    ...
    prototypeTier: "Concept render → consult",
  },
  {
    name: "Exobod Rover",
    href: "/customize?type=rover",
    badge: "Concept",
    bestFor: "Smooth-floor patrol experiments — concept path until a dedicated program opens.",
    motionType: "Target: wheeled base + steerable drivetrain (config-dependent).",
    skillExamples: ["Patrol", "Carry", "Record", "Follow"],
    prototypeTier: "Concept → prototype consult",
  },
  {
    name: "Exobod Utility",
    ...
    prototypeTier: "Concept → custom engineering consult",
  },
  {
    name: "Exobod EDU Kit",
    href: "/customize",
    badge: "Concept",
    bestFor: "STEM cohorts — curriculum bundles are concept / inquiry only until scoped.",
    motionType: "Target: desk or rover-class base with curriculum-safe speed caps.",
    skillExamples: ["Teach", "Patrol", "Gesture", "Assist"],
    prototypeTier: "Concept bundles + educator inquiry",
  },
  {
    ...
    prototypeTier: "Concept → engineering consult",
  },
] as const;
...
export const targetSpecs = [
  ...
  { label: "Body styles", value: "Desk One (EVT path) + concept targets: biped walker, wheeled rover, utility frame, EDU/Proto bundles." },
