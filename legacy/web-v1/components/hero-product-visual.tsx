...
/**
 * Marketing card with the original phone-robot render and feature list.
 */
export function HeroProductVisual() {
  ...
  return (
    <div className="relative mx-auto w-full max-w-md lg:max-w-lg xl:max-w-xl">
      ...
      <div className="relative overflow-hidden rounded-2xl border border-line/60 bg-gradient-to-b from-surface/50 to-background/80 p-4 shadow-[0_40px_120px_rgba(0,0,0,0.5),0_0_0_1px_rgba(255,255,255,0.04)_inset] ring-1 ring-white/[0.06] sm:p-6">
        <Image
