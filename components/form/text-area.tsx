  ...
  return (
    <label className="block space-y-2 text-sm text-text-muted" htmlFor={fieldId}>
      ...
      <textarea
        ...
        id={fieldId}
        className={cn(
          "min-h-[120px] w-full rounded-xl border border-line/80 bg-surface-soft/80 px-3 py-3 text-sm text-text-main outline-none transition focus:border-accent/60 focus:ring-2 focus:ring-accent/30",
